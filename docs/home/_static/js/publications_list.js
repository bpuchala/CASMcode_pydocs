...
(function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // "Showing X of Y" — updates after every search/sort/filter via the
        // list.js "updated" event. matchingItems is the post-filter set;
        // size() is the total (constant once initialised).
        var countEl = document.querySelector(".publications-count-value");
        var totalEl = document.querySelector(".publications-count-total");
        if (totalEl) totalEl.textContent = String(list.size());
