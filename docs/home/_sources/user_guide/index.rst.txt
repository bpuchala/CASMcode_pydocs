...
This user guide focuses on using the CASM software suite as a whole. For individual packages, see the :ref:`CASM Python packages public API reference <python_packages_reference>`.